...
// //   ArrowRight,
// // } from "lucide-react";
// // import { destinations, blogPosts } from "@/lib/content";
...
// import { Button } from "@/components/ui/button"
// import { Card, CardContent } from "@/components/ui/card"
// import { MapPin, Calendar, Users, Camera, Instagram, Facebook, Twitter, Mail, ArrowRight } from "lucide-react"
// import { destinations, blogPosts } from "@/lib/content"
// import { PhotoLightbox } from "@/components/photo-lightbox"
// import type { TravelDestination } from "@/lib/content"
...
//     const subject = encodeURIComponent(`Travel Inquiry from ${contactForm.name || "Website Visitor"}`)
//     const body = encodeURIComponent(`
// Name: ${contactForm.name || "Not provided"}
...
//     const mailtoLink = `mailto:jannatul19112003@gmail.com?subject=${subject}&body=${body}`
...
//               Home
//             </Link>
//             <Link href="#journey" className="text-gray-700 hover:text-emerald-600 transition-colors">
//               My Journey
//             </Link>
...
//         <div className="relative text-center text-white z-10">
//           <h1 className="text-6xl md:text-8xl font-bold mb-4">Embark On</h1>
//           <p className="text-2xl md:text-4xl font-light mb-8">ADVENTURES BEYOND BORDERS</p>
//           <div className="flex flex-col sm:flex-row gap-4 justify-center">
//             <Button
//               size="lg"
//               className="bg-emerald-600 hover:bg-emerald-700 text-white px-8 py-3"
...
//             <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-6">
//               Discover incredible adventures from paragliding and camping to exploring indigenous communities and
//               pristine natural landscapes. Click on any photo to view it in detail.
//             </p>
//             <div className="flex justify-center">
//               <Link href="/gallery">
//                 <Button variant="outline" className="flex items-center gap-2">
...
//         <div className="container mx-auto px-4">
//           <div className="text-center mb-16">
//             <h2 className="text-4xl font-bold text-gray-800 mb-4">Latest Adventures</h2>
//             <p className="text-lg text-gray-600">Recent explorations and discoveries</p>
//           </div>
...
//         <div className="container mx-auto px-4">
//           <div className="text-center mb-16">
//             <h2 className="text-4xl font-bold text-white mb-6">Explorer's Journey Map</h2>
//             <p className="text-xl text-white/90 mb-8">Follow my adventures across Bangladesh</p>
//           </div>
...
//         <div className="container mx-auto px-4">
//           <div className="max-w-4xl mx-auto text-center">
//             <h2 className="text-4xl font-bold text-gray-800 mb-8">About Mamun</h2>
//             <div className="grid md:grid-cols-2 gap-12 items-center">
//               <div className="text-left">
//                 <h3 className="text-2xl font-semibold mb-4">The Bangladesh Explorer</h3>
//                 <p className="text-gray-600 mb-6">
//                   Born with an insatiable curiosity for adventure, I have dedicated my life to exploring not just
//                   Bangladesh, but diverse cultures and landscapes across South Asia. From paragliding in hill stations
//                   to camping under the stars, from connecting with indigenous communities to documenting traditional
//                   ways of life, my passion for authentic travel experiences has taken me on incredible journeys.
//                 </p>
//                 <p className="text-gray-600 mb-6">
//                   Through this blog, I share the hidden gems, rich culture, and incredible stories of Bangladesh.
//                   Whether you're a fellow Bangladeshi or an international traveler, I hope my adventures inspire you to
//                   discover the magic of this land of rivers.
//                 </p>
//                 <div className="flex space-x-4">
//                   <div className="text-center">
//                     <div className="text-2xl font-bold text-emerald-600">{destinations.length}</div>
//                     <div className="text-sm text-gray-500">Photos</div>
//                   </div>
//                   <div className="text-center">
...
//           <div className="text-center mb-16">
//             <h2 className="text-4xl font-bold text-white mb-6">Follow Me</h2>
//             <p className="text-xl text-gray-300 mb-8">Stay connected and join the adventure</p>
//           </div>
...
//               <p className="text-lg text-gray-600">
//                 Have a question about Bangladesh travel or want to share your own adventure? I'd love to hear from you!
//               </p>
//             </div>
...
//                     </Link>
//                     <a
//                       href="mailto:jannatul19112003@gmail.com?subject=Hello%20from%20your%20travel%20blog%20visitor"
//                       className="text-emerald-600 hover:text-emerald-700"
//                     >
//                       <Mail className="w-6 h-6" />
//                     </a>
...
//                 </li>
//                 <li>
//                   <Link href="#journey" className="text-gray-300 hover:text-white">
//                     My Journey
//                   </Link>
//                 </li>
//                 <li>
...
//           </div>
//           <div className="border-t border-gray-700 mt-8 pt-8 text-center">
//             <p className="text-gray-300">© 2024 Mamun The Nomad. All rights reserved.</p>
//           </div>
//         </div>
//       </footer>
//     </div>
...
import { Button } from "@/components/ui/button"
import { Card, CardContent } from "@/components/ui/card"
import { MapPin, Calendar, Users, Camera, Facebook, Mail, ArrowRight } from "lucide-react"
import { destinations, blogPosts } from "@/lib/content"
import { PhotoLightbox } from "@/components/photo-lightbox"
import type { TravelDestination } from "@/lib/content"
